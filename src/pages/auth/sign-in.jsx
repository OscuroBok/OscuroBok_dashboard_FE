    ...
    <section className="m-8 mt-2 flex relative lg:px-2">
      ...
      <div className="w-full lg:w-3/5 mt-10 ">
        <div className="text-center flex items-center justify-center">
          <img
            className="h-10 w-10 xl:h-14 xl:w-14 object-cover"
        ...
        <div className="mt-8 mb-2 mx-auto w-80  lg:w-3/5  ">
          ...
          >
            ...
            <div className="flex flex-col lg:gap-2 items-start justify-center">
              <label htmlFor="email" className="font-roboto text-[#6e6e6e]">
                Email
              </label>
              <input
                type="email"
            ...
            {/* Password */}
            <div className="flex flex-col lg:gap-2 items-start justify-center">
              <label htmlFor="password" className="font-roboto text-[#6e6e6e]">
                Password
              </label>
              <input
                type="password"
                id="password"
                className="h-[29px] text-[14px] text-[#5f5f5f] font-[500] w-full border p-4 rounded-md focus:outline-dotted"
            ...
            <div className="flex items-center justify-end gap-2 ">
              <Typography variant="small" className="font-medium text-gray-900">
                <Link to={"/"} className="text-[#1E4AE9] font-roboto">
                  Forgot Password?
                </Link>
              </Typography>
            </div>
            ...
            <Button
              type="submit"
              className="mt-2 bg-[#162D3A] font-medium"
              fullWidth
            >
              Sign In
            </Button>
